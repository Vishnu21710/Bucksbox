...
const Collection = (props: Props) => {
  return (
    <section className="overflow-hidden md:p-10 p-2 mb-10 bg-purple-50 rounded-lg">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mt-10 lg:mt-0">
              ...
              <div className='flex flex-col gap-5 '>
                ...
                <div className='flex justify-start gap-7 px-5 py-3 bg-white rounded-full collect-card'>
                  <img src="sms.png" className='rounded-full p-2 w-[50px] h-[50px] bg-purple-200 ' alt="" />
                  <div className='flex flex-col gap-2'>
                    <h3 className='font-semibold text-gray-800'>SMS Pay</h3>
                    <p className=' md:text-md text-sm'>Engage customers with SMS pay</p>
                  </div>
                </div>
                <div className='flex justify-start gap-7 px-5 py-3 bg-white rounded-full collect-card'>
                  <img src="qr.png" className='rounded-full p-2 w-[50px] h-[50px] bg-purple-200 ' alt="" />
                  <div className='flex flex-col gap-2'>
                    <h3 className='font-semibold text-gray-800'>QR Payments</h3>
